...
#     1: {
#         "query_match": "‘수면–학습–기억’ 세 개념을 모두 직접적으로 다룹니다.",
#         "focus": "학습 이후 수면이 기억 공고화에 미치는 영향을 중심으로 분석합니다.",
#         "type": "실험 연구 (집단 비교 설계)",
#         "badges": ["핵심 키워드 직접 일치", "비교적 최근 연구"]
#     },
#     2: {
#         "query_match": "수면·학습·기억 간 관계를 직접적으로 다룹니다.",
#         "focus": "기억 유지뿐 아니라 개념 이해와 정보 통합 과정까지 함께 분석합니다.",
#         "type": "실험 기반 신경인지 연구",
#         "badges": ["핵심 키워드 직접 일치", "인용수 높음"]
#     },
#     3: {
#         "query_match": "수면, 기억 공고화, 학습 수행을 모두 포함합니다.",
#         "focus": "수면 이후 학습 내용의 응용 및 일반화 능력까지 분석합니다.",
#         "type": "실험 연구 (수면 vs 각성 비교)",
#         "badges": ["핵심 키워드 직접 일치", "비교적 최근 연구"]
#     },
#     4: {
#         "query_match": "수면과 인지 수행 관련 연구로, 학습·기억과는 간접적으로 연결됩니다.",
#         "focus": "수면 부족이 주의집중 및 수행 정확도에 미치는 영향을 다룹니다.",
#         "type": "실험 연구",
#         "badges": ["주제 간접 관련"]
#     },
#     5: {
#         "query_match": "수면과 인지 수행 중심의 연구로, 기억과는 간접적으로 연결됩니다.",
#         "focus": "실행기능과 주의 통제 등 고차 인지 기능 변화를 분석합니다.",
#         "type": "실험 연구",
#         "badges": ["인용수 높음"]
#     },
#     6: {
#         "query_match": "수면의 질과 수행 변화 중심의 연구로, 학습·기억과는 간접적으로 연결됩니다.",
#         "focus": "수면의 질이 과제 수행 정확도와 안정성에 미치는 영향을 다룹니다.",
#         "type": "관찰 기반 연구",
#         "badges": ["주제 간접 관련"]
#     },
#     7: {
#         "query_match": "수면과 학습 과정의 관계를 직접적으로 다루며, 기억과도 일부 연결됩니다.",
#         "focus": "학습 속도와 문제 해결 효율에 대한 수면 효과를 분석합니다.",
#         "type": "실험 연구",
#         "badges": ["최신 연구"]
#     },
#     8: {
#         "query_match": "수면 조건과 수행 변화 중심의 연구로, 학습·기억과는 간접적으로 연결됩니다.",
#         "focus": "수면 규칙성이 수행 안정성에 미치는 영향을 분석합니다.",
#         "type": "실험 연구",
#         "badges": ["주제 간접 관련"]
#     },
#     9: {
#         "query_match": "수면 제한과 기초 수행 지표를 중심으로 다뤄, 학습·기억과는 거리가 있습니다.",
#         "focus": "반응시간 변동성과 수행 안정성을 분석합니다.",
#         "type": "실험 연구",
#         "badges": ["주제 주변부 연구"]
#     },
#     10: {
#         "query_match": "수면 부족과 전반적 수행 변화를 중심으로 다룹니다.",
#         "focus": "생리 반응과 수행 능력 저하를 함께 분석합니다.",
#         "type": "실험 연구",
#         "badges": ["주제 확장 영역 연구"]
#     }
# }
        ...
        "<div class='xai-box'>"
            ...
            "<div class='xai-item'>"
                ...
                "<div class='xai-content'>"
                    ...
                    f"{highlight_keywords(meta['query_match'])}"
                "</div>"
            "</div>"
            ...
            "<div class='xai-item'>"
                ...
                "<div class='xai-content'>"
                    ...
                    f"{highlight_keywords(meta['focus'])}"
                "</div>"
            "</div>"
            ...
            "<div class='xai-item'>"
                ...
                "<div class='xai-content'>"
                    ...
                    f"{highlight_keywords(meta['contribution'])}"
                "</div>"
            "</div>"
        "</div>"
    )
...
def render_paper_semantic(paper, idx):
    ...
    st.markdown(
        f'<div class="paper-citation">{paper["author"]} · {paper["year"]} · {paper["venue"]} · IF {paper["if_score"]} · 인용 {paper["citation_count"]}회</div>',
        unsafe_allow_html=True
    )
